...
print(days_tomatoes_all_ready())
            ...
            # if line_tot[x+1][y] not in ready or line_tot[x+1][y] not in empty or line_tot[x+1][y] not in to_ready:
            #     to_ready.append(str(x+1)+"_"+str(y))
            # if line_tot[x-1][y] not in ready or line_tot[x-1][y] not in empty or line_tot[x+1][y] not in to_ready:
            #     to_ready.append(str(x-1)+"_"+str(y))
            # if line_tot[x][y+1] not in ready or line_tot[x][y+1] not in empty or line_tot[x+1][y] not in to_ready:
            #     to_ready.append(str(x)+"_"+str(y+1))
            # if line_tot[x][y-1] not in ready or line_tot[x][y-1] not in empty or line_tot[x+1][y] not in to_ready:
            #     to_ready.append(str(x)+"_"+str(y-1))
            # else:
