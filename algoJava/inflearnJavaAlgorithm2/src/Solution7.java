...
public class Solution7 {
    ...
    public int solution(int totNum, int[] markingArr) {
...
//        }
    ...
    public static void main(String[] args) {
        ...
        int[] markingArr = new int[totNum];
        for (int i = 0; i < totNum; i++) {
            markingArr[i] = scanner.nextInt();
        }

        Solution7 solution7 = new Solution7();
        System.out.println(solution7.solution(totNum, markingArr));
