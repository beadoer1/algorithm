...
- _[11053](20210311/11053.py) '가장 긴 증가하는 부분 수열(동적계획법)'_ _**재풀이 완료.** 본인까지의 가장 긴 수열의 길이를 메모이제이션 하는게 포인트_
...
- _[7576](20210311/7576.py) '토마토(DFS와 BFS)'_ _**재풀이 완료.** 정확한 논리가 감이 안잡힐 때는 다른 사람의 코드를 보는게 도움이 된다._
- [1260](20210316/1260.py) 'DFS와 BFS(DFS와 BFS)' **_★★★★★노드에 간선이 없는 경우도 존재한다.★★★★★_**
- [2667](20210318/2667.py) '단지번호붙이기(DFS와 BFS)' 
