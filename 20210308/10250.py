...
# 풀이 1: h진법으로 결과값(호수)이 h(0000..)w(00) 형태일 때 실제로는 w(00)h(0000..)가 답이고 이 자리를 바꾼 것이 답이 된다.
# '틀렸습니다.' 
# import math
...
# 풀이 2 : h진법으로 에서 h의 값은 10(h) 가 된다. 이 점을 고려하고 다시 풀면.. '성공!!'
import math
